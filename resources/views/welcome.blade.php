        ...
        <div class="section text-center section-landing">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <h5 class="description">Puedes revisar nuestra relación completa de productos, compara precios y realizar tus pedidos cuando estés seguro.</h5>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="info">
                            ...
                            <h4 class="info-title">Información rapida</h4>
                            <p>Los pedidos que realices solo los conocerás tú a través de tu panel de usuario. Nadie mas tiene accesso a esta información.</p>
                        </div>
                    </div>
                </div>
            </div>
